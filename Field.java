 ...
 * and potentially a single plant.
 * 
...
public class Field
{
    ...
    public void place(Object object, int row, int col)
    {
        if(object instanceof Plant) {
            place(object, new Location(row, col), 1);
        } else {
            place(object, new Location(row, col), 0);
        }
     ...
     */
    public void place(Object object, Location location, int type)
    {
        field[location.getRow()][location.getCol()][type] = object;
    }
